...
namespace HTTTKeToan.view
{
    public partial class Form3 : Form
    {
        ...
        {
            const string sql = "SELECT * FROM GOC_PHIEU WHERE LOAICT = 'NMHH'";
        ...
        public static Form3 newInstance()
        {
            return new Form3();
        }
        ...
        private void dataGridViewPSO_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex >= 0 && e.RowIndex >= 0)
            {
                ...
                var dt = DbUtils.Instance.ExecuteQuery("CHITIET_PHIEUNHAP @pso", new object[] { pso });
